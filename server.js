...
app.get('/magic/:Will%20I%20Be%20A%20Millionaire', (req, res)=> {const {WillIBeAMillionaire} = req.params
    res.send(`<h1>Will I be a Millionaire? Answer ${eightBall[Math.floor(Math.random()*20)]}</h1>`);
});
